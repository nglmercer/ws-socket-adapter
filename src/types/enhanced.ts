// ============================================================================
// ENHANCED TYPE DEFINITIONS FOR SOCKET.IO COMPATIBILITY
// ============================================================================
...
// ============================================================================
// UNION TYPES FOR CONNECTION STATES AND ERROR TYPES
// ============================================================================
 ...
 */
export type DisconnectReasonUnion = 
  | 'transport close'
  | 'transport error'
  | 'server disconnect'
  | 'client disconnect'
 ...
 */
export type TransportTypeUnion = 
  | 'websocket'
  | 'polling'
  | 'webtransport';
...
// ============================================================================
// CALLBACK TYPES WITH ENHANCED ERROR HANDLING
// ============================================================================
 ...
 */
export type EnhancedAnyEventCallback = (
  event: string, 
  metadata: {
    socketId: string;
    namespace: string;
...
export interface NamespaceState {
  name: string;
  sockets: Map<string, string>; // socketId -> userId mapping
...
// Types are exported individually above, no need for additional export block